...
public class UseStatement extends Statement {
  ...
  public UseStatement(Identifier moduleName, Identifier alias, Location start, Location end) {
    super(start, end);
    this.moduleName = moduleName;
    this.moduleAlias = alias;
    this.compAliasMap = null;
  }

  public UseStatement(Identifier moduleName, Map<Identifier, Identifier> compAliasMap, Location start, Location end) {
    super(start, end);
    this.moduleName = moduleName;
